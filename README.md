# MODEL1310110022: MODEL1310110022
...
`pip install git+https://github.com/biomodels/MODEL1310110022.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110022.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110022 as model`
...
The model of uterus pre menopause cells in endometrial stroma metabolism is
...
and identified by:
[MODEL1310110022](http://identifiers.org/biomodels.db/MODEL1310110022) .
